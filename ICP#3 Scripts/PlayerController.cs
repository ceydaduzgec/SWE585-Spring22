...
public class PlayerController : MonoBehaviour
{
    ...
    {
		// All collectible object must be tagged with "Collectible" tag.
        if (other.gameObject.CompareTag("Collectible") && _playerStateMachine.GetCurrentState() == _playerStateMachine.movingState)
        {
	...
	public bool HasHorizontalVelocity()
	{
		return rb.velocity.x > Mathf.Epsilon || rb.velocity.z > Mathf.Epsilon || rb.velocity.x < -Mathf.Epsilon || rb.velocity.z < -Mathf.Epsilon;
	}
}
